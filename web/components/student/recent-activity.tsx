...
import { UserCheck, ClipboardList, FileText, BookOpen, Clock } from "lucide-react"
import { useToast } from "@/components/ui/use-toast"

interface Activity {
  id: string
  type: "attendance" | "exam" | "complaint" | "subject" | "result"
  description: string
  timestamp: string
}
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        ...
        const response = await fetch("/api/student/recent-activities", {
          headers: {
