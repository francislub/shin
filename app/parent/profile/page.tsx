...
export default function ParentProfile() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setProfile((prev) => ({ ...prev, ...editedProfile }) as ParentProfile)
        setIsEditing(false)
        toast({
  ...
  return (
    <DashboardLayout title="My Profile" requiredRole="Parent">
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="relationship"
                        name="relationship"
                        value={isEditing ? editedProfile.relationship || "" : profile?.relationship || ""}
                        onChange={handleInputChange}
                        disabled={!isEditing}
                      />
                    </div>
